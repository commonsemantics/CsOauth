 ...
 * Modified from https://github.com/spring-projects/spring-security-oauth
 * Customised to not perform the client id comparison check as it was 
 * incorrectly using the username instead of the client id sent to the server.
 * 
 * @author Dave Syer
 * @author Modified - Tom Wilkin
 * 
 */
public class OAuthAuthorizationCodeTokenGranter extends AbstractTokenGranter {

	private static final String GRANT_TYPE = "authorization_code";

	private final AuthorizationCodeServices authorizationCodeServices;

	public OAuthAuthorizationCodeTokenGranter(AuthorizationServerTokenServices tokenServices,
